...
if __name__=='__main__':
    ...
    parser.add_argument('--res',  dest='res',   type=int,   default=256)
    parser.add_argument('--N',    dest='N',     type=int,   default=20)
    parser.add_argument('--nu',   dest='nu',    type=float, default=1e-3)
    parser.add_argument('--delta',dest='delta', type=float, default=1e-4)
    parser.add_argument('--T',    dest='T',     type=float, default=50.0)
    parser.add_argument('--steps',dest='steps', type=int,   default=100)
    parser.add_argument('--name', dest='name',  default='ns_data.mat')
    ...
    for j in range(N//bsize):
        ...
        #Solve NS
        sol, sol_t = navier_stokes_2d(w0, f, args.nu, args.T, args.delta, record_steps)
